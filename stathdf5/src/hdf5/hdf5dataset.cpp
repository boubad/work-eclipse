...
bool HDF5Dataset::get_info(HDF5Object::DataType &type,
...
bool HDF5Dataset::create(HDF5Object::DataType xtype, size_t nRank,
		const size_t *dims) {
...
bool HDF5Dataset::write_any(const std::vector<boost::any> &data,
	...
	HDF5Object::DataType rtype = typeOther;
	boost::any v;
