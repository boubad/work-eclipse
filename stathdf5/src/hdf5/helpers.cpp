...
bool Helpers::my_get_type(hid_t xtype,
		statdata::hdf5::HDF5Object::DataType &type) {
	H5T_class_t clt = ::H5Tget_class(xtype);
	bool bRet = false;
	if (clt == H5T_FLOAT) {
		if (::H5Tequal(xtype, H5T_NATIVE_LDOUBLE) > 0) {
			type = statdata::hdf5::HDF5Object::typeLongDouble;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_DOUBLE) > 0) {
			type = statdata::hdf5::HDF5Object::typeDouble;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_FLOAT) > 0) {
			type = statdata::hdf5::HDF5Object::typeFloat;
			bRet = true;
		} else {
			type = statdata::hdf5::HDF5Object::typeDouble;
			bRet = true;
		...
		if (::H5Tequal(xtype, H5T_NATIVE_ULLONG) > 0) {
			type = statdata::hdf5::HDF5Object::typeULongLong;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_LLONG) > 0) {
			type = statdata::hdf5::HDF5Object::typeLongLong;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_ULONG) > 0) {
			type = statdata::hdf5::HDF5Object::typeULong;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_LONG) > 0) {
			type = statdata::hdf5::HDF5Object::typeLong;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_UINT) > 0) {
			type = statdata::hdf5::HDF5Object::typeUInt;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_INT) > 0) {
			type = statdata::hdf5::HDF5Object::typeInt;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_USHORT) > 0) {
			type = statdata::hdf5::HDF5Object::typeUShort;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_SHORT) > 0) {
			type = statdata::hdf5::HDF5Object::typeShort;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_UCHAR) > 0) {
			type = statdata::hdf5::HDF5Object::typeByte;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_SCHAR) > 0) {
			type = statdata::hdf5::HDF5Object::typeSChar;
			bRet = true;
		} else if (::H5Tequal(xtype, H5T_NATIVE_CHAR) > 0) {
			type = statdata::hdf5::HDF5Object::typeChar;
			bRet = true;
		} else {
			type = statdata::hdf5::HDF5Object::typeInt;
		}
	} else if (clt == H5T_STRING) {
		type = statdata::hdf5::HDF5Object::typeString;
	}
	return bRet;
} // my_get_type
///////////////////////////////////////////
